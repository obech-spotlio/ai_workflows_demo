...
Use git CLI for all version control operations. Create the pull request using the repository's remote hosting API or CLI when available. The Claude Code hooks enforce naming and commit rules. Work with them, not around them.
